    ...
    <div className="max-w-7xl mx-auto p-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Link
            href="/reviews"
            className="p-2 rounded-lg text-gray-500 hover:text-brand-accent hover:bg-gray-100 transition relative"
            title="Reviews"
          >
          ...
          <Link
            href="/settings"
            className="p-2 rounded-lg text-gray-500 hover:text-brand-accent hover:bg-gray-100 transition"
            title="Settings"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
