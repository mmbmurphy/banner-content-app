    ...
    <div className="max-w-6xl mx-auto p-8">
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          {saveStatus === 'error' && (
            <span className="text-red-600 text-sm" title={errorMessage || undefined}>
      ...
      {saveStatus === 'error' && (
        <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg flex items-start gap-3">
          ...
          <div>
            <p className="font-medium text-red-800">Failed to save brand kit</p>
            <p className="text-red-600 text-sm mt-1">{errorMessage || 'Unknown error - please check browser console'}</p>
          </div>
        </div>
      )}
